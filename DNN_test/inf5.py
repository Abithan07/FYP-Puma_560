...
# ============================================================================
# ... (around line 20)
CSV_INPUT_PATH   = "/home/priyankan/Desktop/arm_bot/src/scripts/new_generatedDataset/path_601_joint_states_1.csv"

# --- Auto-generate output path ---
output_dir = "Data"
base_filename = os.path.basename(CSV_INPUT_PATH)
name, ext = os.path.splitext(base_filename)
CSV_OUTPUT_PATH = os.path.join(output_dir, f"{name}_pred{ext}")
